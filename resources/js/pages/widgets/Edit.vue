...
const breadcrumbs = computed<BreadcrumbItem[]>(() => [
    ...
    },
    {
        ...
        href: `/widgets/${props.leadForm.id}/edit`,
    },
]);

const form = useForm({
    name: props.leadForm.name,
    is_active: props.leadForm.is_active,
    submit_button_label: props.leadForm.submit_button_label,
    layout_mode: props.leadForm.layout_mode,
    fields: props.leadForm.fields.map((field) => ({
        label: field.label,
        type: field.type,
...
const submit = (): void => {
    ...
    })).patch(`/widgets/${props.leadForm.id}`);
};
...
<template>
    <Head :title="t('widgets.edit_title')" />
