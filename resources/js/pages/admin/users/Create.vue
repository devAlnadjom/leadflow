...
const props = defineProps<{ companies: Array<any> }>();
...
<template>
    <Head title="Admin — Créer un utilisateur" />
    <AdminLayout>
        <div class="p-8 max-w-2xl">
            <div class="mb-8">
                <Link href="/admin/users" class="text-xs text-slate-500 hover:text-slate-300 mb-2 inline-block">← Retour</Link>
                <h1 class="text-2xl font-bold text-white">Nouvel utilisateur</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-xs font-medium text-slate-400 mb-1">Confirmer *</label>
                ...
                <div class="bg-red-950/20 border border-red-900/30 rounded-xl p-5">
                    <label class="flex items-start gap-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">Donne un accès complet à toute la plateforme et au panneau /admin.</p>
                        </div>
                    </label>
                </div>
