...
const form = useForm({
    ...
    items: props.invoice.items.length ? props.invoice.items : [
...
<template>
    <Head :title="`Éditer Facture ${invoice.invoice_number}`" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Éditer la facture</h1>
